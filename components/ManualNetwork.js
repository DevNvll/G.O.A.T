...
const ManualNetwork = ({ next }) => (
  <div style={{ paddingBottom: '20px' }}>
    ...
    <span style={{ color: 'grey' }}>#debate-lore:</span> Debate entre dois ou
    mais usuários sobre ideias diversas. <br />
    <span style={{ color: 'grey' }}>#sugestões:</span> Dedicado para os demais
    usuários do servidor sugerirem coisas para melhorá-lo. <br />
    <span style={{ color: 'grey' }}>#a-porta-corrediça:</span> Canal destinado à
    avisar os demais usuários da chegada de novos usuários ao servidor, ou então
    de suas saídas. <br />
    <span style={{ color: 'grey' }}>#robco-cybernetics:</span> Lugar para uso de
    comandos de bots. Qualquer comando de bot fora desse canal de texto é
    proibido. <br />
    <span style={{ color: 'grey' }}>#mods-recomendados:</span> Recomendações de
    mods dos demais usuários. Vale somente para jogos de Fallout. Qualquer outra
    recomendação de mod para outros jogos, coloque no #off-topic. <br />
    <span style={{ color: 'grey' }}>#jukebox:</span> Canal dedicado à comandos
    do bot @Mr. New Vegas. <br />
    <span style={{ color: 'grey' }}>#suporte-técnico:</span> Canal para os
    demais usuários se ajudarem com bugs e troubleshootings sobre o jogo. <br />
    ...
    <span style={{ color: 'grey' }}>#mods:</span> Sala de conversação sobre mods
    de Fallout em geral. #pérolas: Coisas engraçadas/ilógicas ditas pelos
    usuários do servidor ou então em algum lugar distinto sobre a lore do jogo.{' '}
    <br />
    <span style={{ color: 'grey' }}>#shitpost:</span> Literalmente tudo que não
    ...
    Toca a primeira música que está em primeiro lugar no campo de pesquisa do
    YouTube.<br />
    <span style={{ color: 'grey' }}>
    ...
    <p>
      -A sala de música atual é o canal de voz The Aces Theatre. O bot @Mr. New
      Vegas só pode ser chamado nesta sala.{' '}
    </p>
    <p>
