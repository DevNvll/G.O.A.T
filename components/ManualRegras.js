...
const Regras = ({ next }) => (
  <div>
    <div>
      ...
      <h1>Vault 130</h1>
      <p>
        Olá, e sejam bem-vindos ao discord oficial do canal Vault 130! Aqui é
        palco para a socialização de tanto inscritos como não-inscritos no
        canal. É, sobretudo, uma maneira da comunidade brasileira de Fallout
        socializar.
      </p>
      <p>
        <b>Moderação:</b> <br />
        <span style={{ color: '#1bff80' }}>Vault Overseer</span> – Músico <br />
        <span style={{ color: '#ffb641' }}>Vault Manager</span> – Neto <br />
    ...
    <div style={{ clear: 'both', paddingBottom: '20px' }}>
      ...
      <Button
        ...
        size="medium"
      >
        Eu concordo com o que está escrito acima; É um contrato explícito que
        tenho com o dono do servidor e caso eu quebre alguma das regras, estarei
        submetido a uma punição proporcional.
      </Button>
    </div>
  </div>
)
