...
const ManualTags = ({ next }) => (
  <div style={{ paddingBottom: '20px' }}>
    <center>
      <Image src="static/tags.png" size="large" />
      <h1>
        Utilize o sistema de tags oferecido pelo bot para adicionar as tags de
        facções que você apoia na franquia, ou então, a tag Sem Especificação.
        Caso não se identifique, terá apenas 30% do acesso ao servidor.
      </h1>
    </center>
    ...
    usuários e os policia, além de cuidar dos canais de texto e de voz. <br />
    ...
    texto e de voz, ajudando também na administração geral do servidor. <br />
    <span style={{ color: '#2ecfff' }}>Vault Technician</span>: Sub-moderador do
    servidor. Cuida dos canais de texto e de voz. <br />
    <span style={{ color: '#e74c3c' }}>Vault Podcaster</span>: Streamer/YouTuber
    do servidor. Basta informar o seu canal do YouTube/Twitch a alguém da staff
    para garantir a tag. Garante acesso ao canal Lives e Podcasts do servidor.{' '}
    <br />
    <span style={{ color: '#ffe84e' }}>Vault Entrepreneur</span>: Doador do
    canal Vault 130 (Via Apoia.se, Paypal, Streamlabs ou cryptos). <br />
    <span style={{ color: '#2143f7' }}>Vault Dweller</span>: Usuário comum do
    servidor. <br />
    <span style={{ color: '#798a75' }}>Wastelander</span>: Usuário recém-chegado
    no servidor, ao qual está pendente de identificação. Possui somente 30% de
    acesso ao servidor. <br />
